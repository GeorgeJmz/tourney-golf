...
export const ScoreTable: React.FC<IScoreTableProps> = ({
  ...
  const cellStyle = (
    ...
    color: "white",
    ...(hasBackground
      ? { backgroundColor: inOrOdd ? "#424242" : "#5B5B5B" }
      : {}),
          ...
          <TableBody>
            {!isLandscape() && (
              <TableRow>
                <TableCell
                  align="center"
                  sx={cellStyle("60px", true, true, true)}
                >
                  {currentTeeBoxDisplayName}
                </TableCell>
                {Array(21)
                  ...
                  .map((value, key) =>
                    key != 9 && key !== 19 && key !== 20 ? (
                      <TableCell
                        align="center"
                        sx={cellStyle("60px", false, true, true)}
                      >
                        {getDistanceCell(key)}
                      </TableCell>
                    ) : (
            ...
            <TableRow>
              <TableCell
                align="center"
                sx={cellStyle("60px", true, true, false)}
              >
                HCP
              </TableCell>
              {Array(21)
                ...
                .map((value, key) =>
                  key != 9 && key !== 19 && key !== 20 ? (
                    <TableCell
                      align="center"
                      sx={cellStyle("60px", false, true, false)}
                    >
                      {getHCPCell(key)}
                    </TableCell>
                  ) : (
