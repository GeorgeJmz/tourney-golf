...
interface IStatsLeagueProps {
  user: UserViewModel;
}

export const StatsLeague: React.FC<IStatsLeagueProps> = observer(({ user }) => {
              ...
              <div>
                ...
                >
                  <Button
                    ...
                    color={stats === "players" ? "secondary" : "primary"}
                  ...
                  {showTeams && (
                    <Button
                      ...
                      color={stats === "teams" ? "secondary" : "primary"}
                      key="teams"
